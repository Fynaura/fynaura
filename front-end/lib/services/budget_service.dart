...
// // import 'package:fynaura/constants/api_constants.dart';
//
// class BudgetService {
...
//     try {
//       final response = await http.get(
//         Uri.parse('$baseUrl/users/check-exists/$userId'),
//       );
//
//       if (response.statusCode == 200) {
//         final data = json.decode(response.body);
...
//         headers: {'Content-Type': 'application/json'},
//         body: json.encode({
//           'collaborators': [userId], // Sending as array to add to existing collaborators
//         }),
//       );
//
//       if (response.statusCode != 200) {
...
//           if (decodedResponse.containsKey('exists')) {
...
//         headers: {'Content-Type': 'application/json'},
//         body: json.encode({
//           'userId': userId, // Changed to match the expected format in controller
//         }),
//       );
//
//       if (response.statusCode != 200) {
...
class BudgetService {
  final String baseUrl = "http://192.168.127.53:3000";
