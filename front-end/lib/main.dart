          ...
          content: Wrap(
            children: [
              GestureDetector(
                ...
                child: CircleAvatar(backgroundImage: AssetImage("assets/avatar1.png"), radius: 30),
              ),
              SizedBox(width: 10),
              GestureDetector(
                onTap: () {
                ...
                child: CircleAvatar(backgroundImage: AssetImage("assets/avatar2.png"), radius: 30),
              ),
            ],
          ),
        );
            ...
            Row(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Itunuoluwa Abidoye", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
