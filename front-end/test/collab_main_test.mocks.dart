...
//
// // Create a testable version of CollabMain that allows injecting a mock service
// class TestableCollabMain extends CollabMain {
//   final BudgetService budgetService;
//
//   const TestableCollabMain({Key? key, required this.budgetService}) : super(key: key);
//
//   @override
//   TestableCollabMainState createState() => TestableCollabMainState();
// }
//
// class TestableCollabMainState extends CollabMainState {
//   @override
//   void initState() {
//     // Replace the private _budgetService with our mock before initState is called
//     final testableWidget = widget as TestableCollabMain;
//     _budgetService = testableWidget.budgetService;
//     super.initState();
//   }
// }
//
...
//       home: TestableCollabMain(budgetService: mockBudgetService),
//     );
//
//     // Build the widget
...
//   });
//
//   testWidgets('CollabMain adds new budget correctly', (WidgetTester tester) async {
//     // Setup the mock service
//     when(mockBudgetService.getBudgets()).thenAnswer((_) async => []);
//     when(mockBudgetService.createBudget(any, any, any, any)).thenAnswer((_) async => true);
//
//     // Create a widget to test
//     final widget = MaterialApp(
//       home: TestableCollabMain(budgetService: mockBudgetService),
...
//     await tester.pumpAndSettle();
//
//     // Note: Testing the actual form submission would require knowing the structure of your CustomPopup
//     // This is just a placeholder for how you might test it
//
//     // Verify that the popup is shown
//     expect(find.byType(CustomPopup), findsOneWidget);
//
//     // For a full test, you would:
//     // 1. Find text fields in the popup
//     // 2. Enter test data
//     // 3. Tap the submit button
//     // 4. Verify createBudget was called with correct parameters
//   });
// }